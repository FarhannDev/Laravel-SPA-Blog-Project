    ...
    @section('breadcrumb')
        ...
        {{ Breadcrumbs::render('story-draft') }}
    @endsection
    <div>
        <div class="p-2">
            <header class="header">
            ...
            <div class=" bg-white border-bottom">
                <div class="p-3">
                    <ul class="nav nav-underline">
                        <li class="nav-item">
                            <a class="nav-link text-dark text-decoration-underline {{ \Route::is('author.stories.drafts' ? 'active' : '') }} "
                                href="{{ route('author.stories.drafts') }}">Draf
                                {{ $posts_count ? $posts_count : null }}</a> </a>
                        </li>
                        <li class="nav-item">
                            ...
                            <div class="posts mx-md-3">
                                ...
                                <div class="d-flex justify-content-arround py-3 mb-3">
                                    <button wire:click="deletePosts({{ $post->id }})" type="button"
                                        ...
                                        Delete</button>
                                    <a data-turbolinks="false" href="{{ route('author.stories.edit', $post->id) }}"
