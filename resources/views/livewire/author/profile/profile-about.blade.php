                    ...
                    <ul class="nav nav-underline">
                        <li class="nav-item">
                            <a class="nav-link text-dark "
                                href="{{ route('author.profile.index', \Auth::user()->username) }}">Home </a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="row pt-3 mb-3">
                    <div class="col-lg-4 col-md-6">
                        <img src="{{ \Auth::user()->avatar ? asset('http://ngeblogid.test/storage/avatar/' . \Auth::user()->avatar) : Gravatar::get('email@example.com', ['size' => 50]) }}"
                            width="250" class="img-fluid rounded-pill mb-3 mx-3" alt="">
                    </div>
                    <div class="col-lg-8 col-md-6">
                        ...
                        <div class="mb-3 row px-3">
                            ...
                            <div class="col-sm-9">
                                <span class="text-dark fw-normal">Lorem ipsum dolor sit amet, consectetur adipisicing
                                    elit. Repudiandae deserunt earum dolore? Consequuntur tempora inventore sapiente non
                                    harum distinctio beatae! Sint eveniet eos molestias fugit impedit architecto, natus
                                    sit doloribus.</span>
                            </div>
                        </div>
                        <div class="mb-3  px-3">
