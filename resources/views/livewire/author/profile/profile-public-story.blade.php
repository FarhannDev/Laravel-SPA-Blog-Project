                           ...
                           <ul class="nav nav-underline">
                               <li class="nav-item">
                                   <a class="nav-link text-dark "
                                       href="{{ route('author.profile.public', $user->username) }}">Tentang
                                       Saya</a>
                               </li>
                               <li class="nav-item">
                                   <a class="nav-link text-dark  {{ Route::is('author.public.story', $user->username) ? 'text-decoration-underline' : '' }}"
                                       href="{{ route('author.public.story', $user->username) }}">Semua Cerita
                                   </a>
                               </li>
                           </ul>
                       </div>
