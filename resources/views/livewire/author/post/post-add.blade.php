<div>
    <div class="card shadow rounded bg-white">
        <div class="card-header">
            <a href="{{ route('author.posts.index') }}" class="text-decoration-none text-dark"><i
                ...
                <div class="d-flex justify-content-center align-content-start border-bottom ">
                    <div class="col-12">
                        <form wire:submit.prevent="savePosts" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="post_slug" class="form-label">Generete SEO</label>
                            ...
                            <div class="d-flex justify-content-end mb-3">
                                <button data-turbolinks="false" type="submit"
                                    class="btn btn-dark rounded">Simpan</button>
                                <a href="{{ route('author.posts.index') }}" class="btn btn-light ms-1">Batalkan</a>
                            </div>
                        </form>
                    </div>
                </div>
