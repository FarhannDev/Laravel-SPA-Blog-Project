        ...
        <div class=" bg-white border-bottom">
            <div class="p-3">
                <ul class="nav nav-underline">
                    <li class="nav-item">
                        <a class="nav-link text-dark " href="{{ route('stories.drafts') }}">Tersimpan </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark " href="{{ route('stories.drafts') }}">Draft </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark  text-decoration-underline {{ \Route::is('stories.publish' ? 'active' : '') }}"
                            href="{{ route('stories.publish') }}">Publish
                            {{ $posts_count ? $posts_count : null }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-dark " href="{{ route('stories.index') }}">Semua
                        </a>
                    </li>
                </ul>
            </div>
